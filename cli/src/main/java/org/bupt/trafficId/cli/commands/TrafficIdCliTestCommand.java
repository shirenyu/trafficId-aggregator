 ...
 */
package org.bupt.trafficId.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.bupt.trafficId.cli.api.TrafficIdCliCommands;
...
public class TrafficIdCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TrafficIdCliTestCommand.class);
    protected final TrafficIdCliCommands service;

    public TrafficIdCliTestCommand(final TrafficIdCliCommands service) {
